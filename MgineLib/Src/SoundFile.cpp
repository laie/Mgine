...
////////////////////////////////////////////////////////////
bool SoundFile::OpenRead(const std::wstring& Filename, std::size_t&, unsigned int&, unsigned int&)
{
    std::wcerr << L"Failed to open sound file \"" << Filename << L"\", format is not supported by SFML" << std::endl;
...
////////////////////////////////////////////////////////////
bool SoundFile::OpenWrite(const std::wstring& Filename, unsigned int, unsigned int)
{
    std::wcerr << L"Failed to open sound file \"" << Filename << L"\", format is not supported by SFML" << std::endl;

...
#include "SoundFileOggStbVorbis.h"
#include <iostream>
...
////////////////////////////////////////////////////////////
bool SoundFileOgg::IsFileSupported(const std::wstring& Filename, bool Read)
{
    if (Read)
    {
        // Open the vorbis stream
        stb_vorbis* Stream = stb_vorbis_open_filename(const_cast<wchar_t*>(Filename.c_str()), NULL, NULL);
...
////////////////////////////////////////////////////////////
bool SoundFileOgg::OpenRead(const std::wstring& Filename, std::size_t& NbSamples, unsigned int& ChannelsCount, unsigned int& SampleRate)
{
    ...
    // Open the vorbis stream
    myStream = stb_vorbis_open_filename(const_cast<wchar_t*>(Filename.c_str()), NULL, NULL);
    if (myStream == NULL)
    {
        std::wcerr << L"Failed to read sound file \"" << Filename << L"\" (cannot open the file)" << std::endl;
        return false;
    }

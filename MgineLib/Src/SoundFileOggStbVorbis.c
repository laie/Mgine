...
stb_vorbis * stb_vorbis_open_filename(wchar_t *filename, int *error, stb_vorbis_alloc *alloc)
{
   FILE *f = NULL; //fopen(filename, "rb");
...
#ifndef STB_VORBIS_NO_STDIO
int stb_vorbis_decode_filename(wchar_t *filename, int *channels, short **output)
{

...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    static SoundFile* CreateRead(const std::wstring& Filename);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static SoundFile* CreateWrite(const std::wstring& Filename, unsigned int ChannelsCount, unsigned int SampleRate);
...
private :
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual bool OpenRead(const std::wstring& Filename, std::size_t& NbSamples, unsigned int& ChannelsCount, unsigned int& SampleRate);
    ...
    ///
    ////////////////////////////////////////////////////////////
    virtual bool OpenWrite(const std::wstring& Filename, unsigned int ChannelsCount, unsigned int SampleRate);
    ...
    std::wstring myFilename;      ///< Path of the file (valid if loaded from a file)
